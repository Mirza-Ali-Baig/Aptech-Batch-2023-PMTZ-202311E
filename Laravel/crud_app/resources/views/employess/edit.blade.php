    ...
    <div class="container">
        <div class="row">
          <div class="col-md-6 offset-md-3">
            <h2 class="text-center text-dark mt-5">Edit Employee</h2>
            <div class="text-center mb-5 text-dark">CRUD APP</div>
            <div class="card my-5">
                
              <form action="/employees/edit/{{ $employee->id }}" method="POST" class="card-body cardbody-color p-lg-5">
                @csrf
                ...
                <div class="text-center"><button type="submit" class="btn btn-primary btn-color px-5 mb-5 w-100">Update Employee</button></div>
              </form>
            </div>
